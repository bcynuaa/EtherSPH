...
const file_name = "cruchaga_3d2";
const file_suffix = ".vtp";
const dir_path = "./Cruchaga3DData2/";
...
function createBoxParticles(particle_type, dx, x_0, y_0, z_0, x_number, y_number, z_number)
    particles = [particle_type(Float64, 3) for i in 1: x_number * y_number * z_number];
...
water_particles = createBoxParticles(LiquidParticleMTh, dr, x0, y0, z0, water_a_number, water_b_number, water_c_number);
