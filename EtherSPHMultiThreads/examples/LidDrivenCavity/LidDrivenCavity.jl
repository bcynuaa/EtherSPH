...
const wc_lm = WeaklyCompressibleLiquidModel(rho_0, c_0, p_0, gamma, mu_0, body_force_vec);
...
lid_particles = createRectangleParticles(ConstVelocityParticle, dr, x0, y0 + lid_length, lid_length_number, lid_thick_number);
...
# left ConstVelocityParticle
left_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 - lid_thick_number * dr, y0, lid_thick_number, lid_length_number);
...
# right ConstVelocityParticle
right_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 + lid_length, y0, lid_thick_number, lid_length_number);
...
# bottom ConstVelocityParticle
bottom_particles = createRectangleParticles(ConstVelocityParticle, dr, x0, y0 - lid_thick_number * dr, lid_length_number, lid_thick_number);
...
# left bottom
left_bottom_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 - lid_thick_number * dr, y0 - lid_thick_number * dr, lid_thick_number, lid_thick_number);
...
# right bottom
right_bottom_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 + lid_length, y0 - lid_thick_number * dr, lid_thick_number, lid_thick_number);
...
# left top
left_top_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 - lid_thick_number * dr, y0 + lid_length, lid_thick_number, lid_thick_number);
...
# right top
right_top_particles = createRectangleParticles(ConstVelocityParticle, dr, x0 + lid_length, y0 + lid_length, lid_thick_number, lid_thick_number);
